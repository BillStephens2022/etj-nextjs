    ...
    <>
      ...
      <div className={classes.about_container}>
        ...
        <div className={classes.about_item}>
          ...
          <div className={classes.chris_img_div}>
            <Image
              src={chris}
              alt="Chris Johnson"
              width={200}
              ...
              className={classes.chris_img}
            />
          </div>

          <h4 className={classes.name_heading}>Chris T. Johnson</h4>
          <h5 className={classes.job_title}>Founder</h5>
          <p className={classes.about_p}>
            Christopher Thomas Johnson (CJ) was born in Brooklyn, NY to Pastor
            Thomas and Barbara Johnson. He was raised in Glen Rock, New Jersey. <br /><br />
            ...
            OPERATION. <br /><br />CJ received a Master of Government Administration from
            the University of Pennsylvania, Fels Center of Government in 2002
            and was awarded the Fels Leadership Award. He was honorably
            discharged from the U.S. Navy as a Lieutenant Commander in September
            of 2002 after serving as the Executive Officer of Naval Reserve
            Center, Fort Dix. In the private sector, CJ was the Director of
            Government Affairs & Contracts for MAR-VEL International, Inc. from
            2002-2009. There he was responsible for numerous multimillion-dollar
            contracts and programs. <br /><br />In 2013, he earned his Master of Divinity
            from Palmer Theological Seminary. He was the Pastoral Minister for
            Covenant House Atlantic City (South Jersey) from 2013-2015. Covenant
            House is the largest privately funded agency in the Americas
            providing shelter, food, immediate crisis care, and an array of
            other services to homeless and runaway youth.  <br /><br /> CJ has earned his 2nd
            Degree Black Belt in Traditional Okinawan GOJU RYU Karate (while in
            Okinawa, Japan), a blue belt in Brazilian Jiu Jitsu and a 1st Degree
            Black Belt in Kumdo. CJ, his wonderful wife and children are members
            of Grace Temple Baptist Church of Lawnside, New Jersey where he is
          ...
          <h4 className={classes.name_heading}>Obadiah Schottenfeld</h4>
          <h5 className={classes.job_title}>Vice President</h5>
          <p className={classes.about_p}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
            Habitasse platea dictumst vestibulum rhoncus est pellentesque. Diam
            volutpat commodo sed egestas egestas fringilla phasellus faucibus. <br /><br />
            At in tellus integer feugiat scelerisque. Sollicitudin nibh sit amet
            commodo nulla facilisi nullam vehicula ipsum. Quam lacus suspendisse
            faucibus interdum posuere lorem ipsum dolor. Semper feugiat nibh sed
            pulvinar. Odio aenean sed adipiscing diam donec adipiscing
            tristique. 
          </p>
          <div className={classes.chris_img_div}>
            <Image
          ...
          <h4 className={classes.name_heading}>Abraham Summers</h4>
          <h5 className={classes.job_title}>Treasurer</h5>
          <p className={classes.about_p}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
            Consectetur adipiscing elit duis tristique sollicitudin nibh sit
            amet. Non quam lacus suspendisse faucibus. Sapien et ligula
            ullamcorper malesuada proin libero nunc consequat interdum. Augue ut
            lectus arcu bibendum at varius. <br /> <br />Bibendum arcu vitae elementum
            curabitur. Nam at lectus urna duis convallis convallis. Massa id
            neque aliquam vestibulum morbi blandit cursus. Pellentesque pulvinar
            pellentesque habitant morbi tristique senectus et netus et.
            Suspendisse interdum consectetur libero id. Non consectetur a erat
